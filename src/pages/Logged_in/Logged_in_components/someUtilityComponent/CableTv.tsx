      ...
      {isModalOpen && (
        <div className="fixed inset-0 flex  items-center justify-center bg-black/40  z-[20]">
          ...
          <div className="p-[0.8rem]  rounded-[20px] bg-[#fff]/20">
            <div className="bg-white  sm:w-[600px] w-[100vw] sm:h-auto h-[min(100dvh,100vh)] max-h-screen  overflow-y-auto    z-[50]  px-4 py-6 sm:rounded-[15px] shadow-lg flex flex-col">
              ...
              <div className="flex justify-center items-center">
                <div className="sm:w-[70%] w-full">
                  ...
                  <form onSubmit={handleSubmit}>
                    <p className="text-[#0A2E65]/60 pb-[3px]  pl-[5px] text-[16px] text-left sm:mt-[2rem] mt-[3rem] ">
                      Service Provider
                    </p>
                    <div>
                      <Select
                    ...
                    <p className="text-[#0A2E65]/60 pb-[3px] pl-[5px] text-[16px] text-left  sm:mt-[10px] mt-[17px] ">
                      Package/Bouquet
                    </p>
                    <div>
                      <Select
