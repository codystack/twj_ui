...
const SellGiftCard = () => {
    return (
        <button className=" sm:h-[156px] h-[180px] sm:min-w-[291px] min-w-auto border    border-[#F2F4FC]  transition duration-300 rounded-[10px]  cursor-pointer   hover:border relative   bg-[#F2F4FC] hover:border-[#326CF6]  flex flex-col items-start ">
        <div className="p-5">
